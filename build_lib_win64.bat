...
REM کامپایل فایل‌های منبع C با تنظیمات 64 بیتی
...
echo.
echo برای استفاده از این کتابخانه، مطمئن شوید که:
echo 1. از پایتون 64 بیتی استفاده می‌کنید
echo 2. کتابخانه در مسیر صحیح قرار دارد.
goto end
