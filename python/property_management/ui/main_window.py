...
class MainWindow(QMainWindow):
    ...
    def create_menus(self):
        ...
        property_count_action.triggered.connect(self.report_tab.generate_property_count_report)
        ...
        property_value_action.triggered.connect(self.report_tab.generate_property_value_report)
        ...
        district_report_action.triggered.connect(self.report_tab.generate_district_report)
    ...
    def show_help(self):
        ...
        help_file = os.path.join(os.path.dirname(__file__), "..", "resources", "help", "index.html")
