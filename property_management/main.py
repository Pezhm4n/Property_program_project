...
# وارد کردن ماژول‌های برنامه - با مسیرهای اصلاح شده
from ui.login_dialog import LoginDialog
from ui.main_window import MainWindow
from property_management.user_management import UserManager
from property_management.utils import setup_logging
...
def setup_qt_application():
    ...
    icon_path = os.path.join(project_dir, 'ui', 'resources', 'icons', 'app_icon.png')
...
def show_splash_screen():
    ...
    # مسیر اصلاح شده برای ساختار جدید
    splash_path = os.path.join(project_dir, 'ui', 'resources', 'images', 'splash.png')
