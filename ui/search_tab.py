...
class SearchTab(QWidget):
    ...
    def setup_ui(self):
        ...
        # ویجت نتایج جستجو - ایجاد قبل از فیلترها
    ...
    def setup_search_filters(self, layout):
        ...
        # به جای فراخوانی مستقیم، ویجت استک را به صورت مستقیم تنظیم می‌کنیم
        self.property_filters_stack.setCurrentIndex(0)
    ...
    def on_property_type_changed(self, index):
        ...
        # پاک کردن نتایج جستجوی قبلی (اگر جدول نتایج ایجاد شده باشد)
